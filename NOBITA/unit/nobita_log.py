import requests
from NOBITA import TOKEN

CHAT_ID = -100
BOT_USERNAME = "@Nobita\\Grabber\\Bot"  # Escaped underscores for bot username
OWNER_NAME = "@ll_YOURR\\_NOBITA_ll"  # Escaped underscores for owner's username
