...
- `@NobitaGrabberBot query` → Search for characters.
- `@NobitaGrabberBot collection.<user_id>` → View a user's character collection.
- `@NobitaGrabberBot collection.<user_id> <name>` → Search within a user's collection.
- `@NobitaGrabberBot <query>.AMV` → Show characters with video clips.
